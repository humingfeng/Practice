        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" autocomplete="off" class="layui-input" placeholder="教育局名称">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-normal newsAdd_btn do-action"
                   data-type="handle" data-url="/auth/jump/baseinfo/edu_handle"
                   data-name="教育局新增"><i class="iconfont icon-add"></i>教育局新增</a>
            </div>
        </div>
    </form>
</div>
            ...
            <tr>
                ...
                <td>{{# if (item.status) { }}
                    <a class="iconfont icon-keyong do-action-page" data-type="update"
                       data-url="/auth/baseinfo/edu/update" data-index="{{index}}" ></a>
                    {{# } else { }}
                ...
                <td>
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-small do-action"
                           data-type="handle" data-url="/auth/jump/baseinfo/edu_handle?id={{item.id}}" data-name="编辑">
                    ...
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-small layui-btn-danger do-action-page" data-type="deleteUrl"
                           data-url="/auth/baseinfo/edu/delete/{{item.id}}" data-name="{{item.name}},删除会影响该教育局下的学校" data-index="{{index}}">
