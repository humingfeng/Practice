        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" autocomplete="off" class="layui-input" placeholder="基地名称">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-normal newsAdd_btn do-action"
                   data-type="handle" data-url="/auth/jump/baseinfo/bases_handle"
                   data-name="基地新增"><i class="iconfont icon-add"></i>基地新增</a>
            </div>
        </div>
    </form>
</div>
            ...
            <tr>
                ...
                <td>{{# if (item.status) { }}
                    <a class="iconfont icon-keyong do-action-page" data-type="update"
                       data-url="/auth/baseinfo/bases/update" data-index="{{index}}" ></a>
                    {{# } else { }}
                ...
                <td>
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-small do-action"
                           data-type="handle" data-url="/auth/jump/baseinfo/bases_handle?id={{item.id}}" data-name="编辑">
                    ...
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-small layui-btn-danger do-action-page" data-type="deleteUrl"
                           data-url="/auth/baseinfo/bases/delete/{{item.id}}" data-name="{{item.name}},删除会影响关联的活动" data-index="{{index}}">
