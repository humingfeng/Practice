...
<fieldset class="layui-elem-field"  style="width: 710px">
    <blockquote class="layui-elem-quote layui-quote-nm qute-blue">教师新增</blockquote>
    <div class="layui-row">
        <div class="layui-col-md12">
            <form class="layui-form layui-form-pane" id="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" class="layui-input" lay-verify="empty" lay-verType="tips" maxlength="20" placeholder="请输入教师名称" >
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">教师身份</label>
                    <div class="layui-input-block">
                        <select name="classifyId" id="classifyId" lay-filter="classifyId" lay-search lay-verify="empty" lay-verType="tips" placeholder="请选教师身份">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="phone" class="layui-input" lay-verify="empty|phone|number" lay-verType="tips" maxlength="11"  placeholder="请输入联系方式">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/javascript">
    layui.config({base:"/static/js/"}).use(['app','form','jsonToForm'],function(){
        ...
        var url = "/auth/personnel/teacher/add";
        ...
        app.get('/auth/system/dictionary/type/TEACHER_TYPE').then(d=>{
        ...
        app.get('/auth/baseinfo/school/usable/list').then(d=>{
            ...
            if(id){
                url = "/auth/personnel/teacher/update";
                app.get('/auth/personnel/teacher/'+id).then(d=>{
