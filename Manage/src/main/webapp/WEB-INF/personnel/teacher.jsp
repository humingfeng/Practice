        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-normal newsAdd_btn do-action"
                   data-type="handle" data-url="/auth/jump/personnel/teacher_handle"
                   data-name="新增教师"><i class="iconfont icon-add"></i>新增教师</a>
                <a class="layui-btn layui-btn-normal layui-btn-warm do-action"
                   data-type="handle" data-url="/auth/jump/personnel/teacher_export"
            ...
            <tr>
                ...
                <td>{{# if (item.status) { }}
                    <a class="iconfont icon-keyong do-action-page" data-type="update"
                       data-url="/auth/personnel/teacher/update" data-index="{{index}}" ></a>
                    {{# } else { }}
                ...
                <td>
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-xs do-action"
                           data-type="handle" data-url="/auth/jump/personnel/teacher_handle?id={{item.id}}" data-name="编辑">
                    ...
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-xs layui-btn-danger do-action-page" data-type="deleteUrl"
                           data-url="/auth/personnel/teacher/del/{{item.id}}" data-name="{{item.name}},删除会影响部分功能，慎重！" data-index="{{index}}">
    ...
    layui.config({base:"/static/js/"}).use(['pagelist','app','form'],function(){
        var $ = layui.$,form = layui.form,
            page = layui.pagelist({
                ...
                pageIndex:1,
                pageSize:10,
                url:'/auth/personnel/teacher/list'});
        page.render();
    })
</script>
</body>
