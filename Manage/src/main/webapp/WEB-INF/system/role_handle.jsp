...
<fieldset class="layui-elem-field"  style="width: 500px">
    <blockquote class="layui-elem-quote layui-quote-nm qute-blue">角色新增</blockquote>
    <div class="layui-row">
            ...
            <form class="layui-form layui-form-pane" id="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" class="layui-input" lay-verify="required" maxlength="20" placeholder="请输入角色名称">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script type="text/javascript">
    layui.config({base:"/static/js/"}).use(['app','form','jsonToForm'],function(){
        ...
        var url = "/auth/system/role/add";

        if(id){

            var load = app.showLoading();
            url = "/auth/system/role/update";
            app.get('/auth/system/role/'+id).then(d=>{
