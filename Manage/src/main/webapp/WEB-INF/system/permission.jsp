        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" autocomplete="off" class="layui-input" placeholder="权限名称">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-normal newsAdd_btn do-action"
                   data-type="handle" data-url="/auth/jump/system/permission_handle"
                   data-name="权限新增"><i class="iconfont icon-add"></i>权限新增</a>
            </div>
        </div>
    </form>
</div>
            ...
            <tr>
                ...
                <td>{{# if (item.status) { }}
                    <a class="iconfont icon-keyong do-action-page" data-type="update"
                       data-url="/auth/system/permission/update" data-index="{{index}}" ></a>
                    {{# } else { }}
    ...
    layui.config({base:"/static/js/"}).use(['pagelist','app','form'],function(){
        var $ = layui.$,form = layui.form,
            page = layui.pagelist({
                ...
                pageIndex:1,
                pageSize:10,
                url:'/auth/system/permission/list'});
        page.render();
    })
</script>
</body>
