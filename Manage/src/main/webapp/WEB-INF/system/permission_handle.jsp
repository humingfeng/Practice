...
<fieldset class="layui-elem-field"  style="width: 500px">
    <blockquote class="layui-elem-quote layui-quote-nm">权限新增</blockquote>
    <div class="layui-row">
            ...
            <form class="layui-form layui-form-pane" id="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" class="layui-input" lay-verify="required" maxlength="20" placeholder="请输入权限名称">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">权限URL</label>
                    <div class="layui-input-block">
                        <input type="text" name="url"  class="layui-input" lay-verify="required" maxlength="100" placeholder="请输入权限URL">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script type="text/javascript">
    layui.config({base:"/static/js/"}).use(['app','form','jsonToForm'],function(){
        ...
        var url = "/auth/system/permission/add";

        if(id){
            var load = app.showLoading();
            url = "/auth/system/permission/update";
            app.get('/auth/system/permission/'+id).then(d=>{
