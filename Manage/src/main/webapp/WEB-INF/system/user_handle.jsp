            ...
            <form class="layui-form layui-form-pane" id="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="account" class="layui-input" lay-verify="required" maxlength="50" placeholder="请输入帐号">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">昵称</label>
                    <div class="layui-input-block">
                        <input type="text" name="nickName" class="layui-input" lay-verify="required" maxlength="100" placeholder="请输入昵称">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">手机号</label>
                    <div class="layui-input-block">
                        <input type="text" name="phone"  class="layui-input" lay-verify="required|phone|number" maxlength="11" placeholder="请输入手机号">
                    </div>
                </div>
                <div class="layui-form-item ">
                    <label class="layui-form-label">组织</label>
                    <div class="layui-input-block">
                        <select name="organizeId" lay-verify="required" id="organizeId">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="password" name="password" class="layui-input" lay-verify="pass"  placeholder="请输入密码">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script type="text/javascript">
    layui.config({base:"/static/js/"}).use(['app','form','jsonToForm'],function(){
        ...
        form.on("submit(submit)",data=>{
            if(pass!=data.field.password){
                data.field.password = app.sha(data.field.password);
            }
