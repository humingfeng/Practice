        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" autocomplete="off" class="layui-input" placeholder="主题名称">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-normal newsAdd_btn do-action"
                   data-type="handle" data-url="/auth/jump/activity/theme_handle"
                   data-name="主题新增"><i class="iconfont icon-add"></i>主题新增</a>
            </div>
        </div>
    </form>
</div>
            ...
            <tr>
                ...
                <td>{{# if (item.status) { }}
                    <a class="iconfont icon-keyong do-action-page" data-type="update"
                       data-url="/auth/activity/theme/update" data-index="{{index}}" ></a>
                    {{# } else { }}
